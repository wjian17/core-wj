...
public class EasypoiUtils {
    ...
    public static void main(String[] args) {
        String filePath = "C:\\Users\\wjian\\Desktop\\3.xlsx";
        String filePath1 = "C:\\Users\\wjian\\Desktop\\4.xls";
//        WorkbookFactory
        List<ParyMember> members = EasypoiUtils.importExcel(filePath,1,1,ParyMember.class);
        ...
        EasypoiUtils.exportExcel(list,"title","sheetName", ParyMember.class,filePath1,null);
        for(ParyMember paryMember:members){
            System.out.println(paryMember.toString());
        }
    }
