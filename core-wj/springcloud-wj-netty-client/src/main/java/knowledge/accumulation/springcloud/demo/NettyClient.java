...
import knowledge.accumulation.springcloud.controller.TestController;
...
//    }
    ...
    public static void main(String[] args) throws Exception {
        knowledge.accumulation.springcloud.config.NettyClient nettyClient = new knowledge.accumulation.springcloud.config.NettyClient("localhost",11111);
        ...
        Object object = nettyClient.remoteCall(methodInvokeMeta,0);
